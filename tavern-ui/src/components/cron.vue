<template lang="html">
  <div class="cron" :val="value_">
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane :label="value" disabled="true">
      </el-tab-pane>
    </el-tabs>
    <div style="text-align: center; margin-top: 10px;">
      <el-button type="primary" @click="sureCron" size="mini">确认</el-button>
      <el-button type="primary" @click="cancleCron" size="mini">取消</el-button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    cancleCron(){
      this.$emit('input', JSON.parse(this.valueJsonstr))
      this.$emit('close')
    }
  },
  created () {
    this.updateVal()
    this.valueJsonstr = JSON.stringify(this.value)
  },
  components: {
